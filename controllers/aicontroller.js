...
export const removeImageObject = async (req, res) => {
    try {
        ...
        // here will upload to the cloudinary
        ...
        // here will upload to the neon database
...
export const resumeReview = async (req, res) => {
    try {
        ...
        const prompt = `Review the following resume and provide constructive feedback on its strenths, weaknesses, and areas for improvement. Resume content:\n\n${pdfData.text}`
